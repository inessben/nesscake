        ...
        <section className="about">
            ...
            <section className="about-section">
                <p className="about-text" > Je vous invite à entrer dans mon univers les Nesscake's, là
                    ...
                    <br />
                    Ici, on croit fermement que la vie est trop courte pour résister à une bonne dose de sucre.
                    Des cupcakes aux pancakes, en passant par des gâteaux dignes de ce nom.
                    <br />
                    Étudiante en informatique le jour, pâtissière du dimanche la nuit. J'ai développé ce site pour allier ces deux domaine pour lesquelles je porte de l'intérêt.
                    <br />
