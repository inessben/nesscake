    ...
    return (
        <div className="Home">
            ...
            <div className="Home-news">
                ...
                <h3 className="Home-news-subtitle">voici les actualités qui vont vous régaler :</h3>
                    ...
                    <div className="image-container">
                        <a href="https://www.instagram.com/faysitiscookies/" target="_blank" rel="noreferrer">
                            ...
                            <div className="image-overlay">
                                <p>Les meilleurs cookies de la capitale qui innove avec des cookies salé, à tester absolument - Fay’siTis (75011)</p>
                            </div>
                        </a>
                    </div>
                    <div className="image-container">
                        <a href="https://www.instagram.com/lapepinieredesbatignolles/" target="_blank" rel="noreferrer">
                            ...
                            <div className="image-overlay">
                                <p>Le café où tu peux télétravailler et boire l’un des meilleurs latté de Paris - La pépinière des Batignolles (75017)</p>
                            </div>
                        </a>
                    </div>
                    <div className="image-container">
                        <a href="https://www.instagram.com/saon.comedyclub/" target="_blank" rel="noreferrer">
                            ...
                            <div className="image-overlay">
                                <p>Un resto où tu peux manger et regarder des humoristes faire des sketch - Saon Thaï (94270)</p>
                            </div>
                        </a>
                    </div>
                </div>
