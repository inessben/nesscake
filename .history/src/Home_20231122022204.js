    ...
    <div className="Home">
      ...
      <div className="Home-news">
        ...
        <div className="image-container">
          ...
          <div className="image-text"><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro blaoloremque!</p>
          </div>
        </div>
        <div className="image-container">
          <img src={image1} className="image2" alt="image" />
          <div className="image-text"><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis minus minima repellat ab libero quasi corrupti Porro blaoloremque!</p>
          </div>
        </div>
        <div className="image-container">
          <img src={image1} className="image3" alt="image" />
          <div className="image-text"><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. sit amet consectetur adipisicing elit. Porro bl noiunxbgq bqgau is Porro blaoloremque!</p>
          </div>
        </div>
        <div className="image-container">
          <img src={image1} className="image4" alt="image" />
          <div className="image-text"><p>Lorem ipsum dolor sit amet consectetur  Porro blaoloremque!</p>
          </div>
        </div>
      </div>
