  ...
  return (
    <div className="Home">
      ...
      <div className="Home-news">
        ...
        <div className="image1-container">
          <img src={image1} className="image1" alt="image" />
          <div className="image1-text"><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis minus minima repellat ab libero quasi corrupti Porro blaoloremque!</p>
          </div>
        </div>
        <div className="image1-container">
          <img src={image1} className="image1" alt="image" />
          <div className="image1-text"><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. sit amet consectetur adipisicing elit. Porro bl noiunxbgq bqgau is Porro blaoloremque!</p>
          </div>
        </div>
        <div className="image1-container">
          <img src={image1} className="image1" alt="image" />
          <div className="image1-text"><p>Lorem ipsum dolor sit amet consectetur  Porro blaoloremque!</p>
          </div>
        </div>
      </div>
