    ...
    <div className="Home">
      ...
      <div className="Home-news">
        ...
        <div className="image2-container">
          ...
          <div className="image2-text"><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis minus minima!</p>
          </div>
        </div>
        <div className="image3-container">
          <img src={image3} className="image3" alt="image" />
          <div className="image3-text"><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. sit amet consectete!</p>
          </div>
        </div>
        </div>
      </div>
