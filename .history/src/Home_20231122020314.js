    ...
    <div className="Home">
      ...
      <div className="Home-news">
        ...
        <div className="images">
          ...
          <p className="image1-description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro blaoloremque!</p>
          <img src={image2} className="image2" alt="image" />
          <p className="image2-description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro bl noiunxbgq bqgau is xmmma oloremque!</p>
          <img src={image3} className="image3" alt="image" />
          <p className="image3-description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro bklosf greaut laoloremque!</p>
          <img src={image4} className="image4" alt="image" />
          <p className="image4-description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis minus minima repellat ab libero quasi corrupti ipsum ratione fuga labore nisi molestiae, dolores praesentium facere. Cu</p>
        </div>
      </div>
